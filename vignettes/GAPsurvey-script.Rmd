...
```{r public_data-learn, echo = FALSE}
...
```{r species_data-learn, echo = FALSE}
...
```{r PolySpecies-learn, echo = FALSE}
...
```{r convert_ctd_btd-do-ph, eval = FALSE}
 convert_ctd_btd(
   filepath_hex = system.file(paste0("exdata/convert_ctd_btd/",
